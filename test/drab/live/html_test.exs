defmodule Drab.Live.HtmlTest do
    ...
    {:case, [generated: true],
     [{{:., [line: 7],
       ...
       [{:var!, [line: 7, context: Drab.Live.EExEngine, import: Kernel],
         [{:assigns, [line: 7], Drab.Live.EExEngine}]}, :color]},
      [do: [{:->, [generated: true],
  ...
  @simple_buffer_with_attribute [{:__block__, [],
  [{:=, [],
    [{:tmp1, [], Drab.Live.EExEngine},
     ["\n<span drab-partial='gi3tgnrzg44tmnbs'>\n",
      "<div id=\"begin\" style=\"display: none;\"></div>\n<div id=\"drab_pid\" style=\"display: none;\">\
  ...
  test "injecting attribute is already there" do
    assert inject_attribute_to_last_opened(@simple_buffer_with_attribute, "drab-ampere=test-ampere") ==
  ...
  test "amperes from simple buffer" do
    assert amperes_from_buffer({:safe, @simple_buffer_with_attribute}) ==
      %{"ge2tamztgq3tcny" => [{:html, "div", "innerHTML", "<span before-color=\"before-color\">\n\
    {{{{@drab-expr-hash:gi3tgmjvgy2tonjx}}}}{{{{/@drab-expr-hash:gi3tgmjvgy2tonjx}}}}\n  </span>"}]}
  end

  test "case sensitive property name" do
    assert case_sensitive_prop_name("<tag drab-ampere=\"AMP\" @Property=value>", "AMP", "property")
      == "Property"
    assert case_sensitive_prop_name("<tag drab-ampere=\"AMP\" @property=value>", "AMP", "property")
      == "property"
              ...
              {:case, [generated: true],
               [{{:., [line: 8],
                  [{:__aliases__, [line: 8, alias: false],
                    [:Phoenix, :HTML, :Engine]}, :fetch_assign]}, [line: 8],
                 [{:var!,
                   [line: 8, context: Drab.Live.EExEngine, import: Kernel],
                   [{:assigns, [line: 8], Drab.Live.EExEngine}]}, :link]},
                [do: [{:->, [generated: true],
                   [[safe: {:data, [generated: true], Drab.Live.EExEngine}],
                    {:data, [generated: true], Drab.Live.EExEngine}]},
                  {:->, [generated: true],
                  ...
                  {:->, [generated: true],
                   [[{:other, [generated: true], Drab.Live.EExEngine}],
                    {{:., [line: 8],
                      [{:__aliases__, [line: 8, alias: false],
                        [:Phoenix, :HTML, :Safe]}, :to_iodata]}, [line: 8],
                     [{:other, [line: 8], Drab.Live.EExEngine}]}]}]]]},
              "{{{{/@drab-expr-hash:geztcmrqgmzteobq}}}}"]]},
           "\n    </b>\n  "]}]]},
      [do: [{:->, [generated: true],
         [[safe: {:data, [generated: true], Drab.Live.EExEngine}],
