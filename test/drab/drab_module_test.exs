defmodule Drab.DrabModuleTest do
  ...
  describe "prerequisites" do
    test "modules" do
      ...
      assert DrabModule.all_modules_for([Drab.Query, Drab.Live]) == [Drab.Live, Drab.Query, Drab.Core]
      assert DrabModule.all_modules_for([Drab.Modal, Drab.Live]) == [Drab.Live, Drab.Query, Drab.Modal, Drab.Core]
    end
    ...
    test "templates" do
      ...
      assert DrabModule.all_templates_for([Drab.Live]) == ["drab.live.js", "drab.core.js", "drab.events.js"]
      assert DrabModule.all_templates_for([Drab.Waiter]) == ["drab.waiter.js", "drab.core.js", "drab.events.js"]
      assert DrabModule.all_templates_for([Drab.Modal]) == ["drab.modal.js", "drab.core.js", "drab.events.js"]
