defmodule DrabTestApp.LiveController do
  ...
  def index(conn, _params) do
    render conn, "index.html", users: @users, count: length(@users), color: "#ffffff", text: "set in the controller"
  end

  def form(conn, _params) do
    render conn, "form.html", text1: "text1 initial value", select1: "2", textarea1: "textarea initial value",
      out: %{}, text: "set in the controller"
  end

  def table(conn, _params) do
    render conn, "table.html", users: @users, link: "https://tg.pl/drab", text: "set in the controller"
  end

  def form_for(conn, _params) do
    render conn, "form_for.html", list: ["From controller", "Also from controller"], text: "set in the controller"
  end
